...
export class BreakdownVehicleComponent implements OnInit {
  ...
  loadBreakdownRecords(): void {
    ...
    this.breakdownRecords = [
      ...
      {
        id: 2,
        vehicleNumber: 'AS21596',
        routeNumber: '15B',
        driverId: 'D002',
        conductorId: 'C002',
        tripCompleted: '3',
        kmDriven: '85',
        placeOfBreakdown: 'Khanapara',
        dateOfBreakdown: new Date('2026-01-28'),
        timeOfBreakdown: '14:20',
        causeOfBreakdown: 'Tire puncture',
        remarks: 'Minor issue, fixed on spot',
      },
      {
        id: 3,
        vehicleNumber: 'AS21597',
        routeNumber: '20C',
        driverId: 'D003',
        conductorId: 'C003',
        tripCompleted: '7',
        kmDriven: '150',
        placeOfBreakdown: 'Beltola',
        dateOfBreakdown: new Date('2026-01-27'),
        timeOfBreakdown: '10:15',
        causeOfBreakdown: 'Brake system malfunction',
        remarks: 'Sent to workshop',
      },
      {
        id: 4,
        vehicleNumber: 'AS21598',
        routeNumber: '8A',
        driverId: 'D004',
        conductorId: 'C004',
        tripCompleted: '4',
        kmDriven: '95',
        placeOfBreakdown: 'Six Mile',
        dateOfBreakdown: new Date('2026-01-26'),
        timeOfBreakdown: '09:30',
        causeOfBreakdown: 'Electrical fault',
        remarks: 'Battery issue resolved',
      },
      {
        id: 5,
        vehicleNumber: 'AS21599',
        routeNumber: '18D',
        driverId: 'D005',
        conductorId: 'C005',
        tripCompleted: '6',
        kmDriven: '140',
        placeOfBreakdown: 'Jalukbari',
        dateOfBreakdown: new Date('2026-01-25'),
        timeOfBreakdown: '16:45',
        causeOfBreakdown: 'Fuel pump failure',
        remarks: 'Replacement needed',
      },
      // Add more sample records to test pagination properly
      {
        id: 6,
        vehicleNumber: 'AS21600',
        routeNumber: '22A',
        driverId: 'D006',
        conductorId: 'C006',
        tripCompleted: '8',
        kmDriven: '175',
        placeOfBreakdown: 'Maligaon',
        dateOfBreakdown: new Date('2026-01-24'),
        timeOfBreakdown: '11:20',
        causeOfBreakdown: 'Transmission problem',
        remarks: 'Major repair required',
      },
      {
        id: 7,
        vehicleNumber: 'AS21601',
        routeNumber: '5C',
        driverId: 'D007',
        conductorId: 'C007',
        tripCompleted: '2',
        kmDriven: '60',
        placeOfBreakdown: 'Dispur',
        dateOfBreakdown: new Date('2026-01-23'),
        timeOfBreakdown: '13:15',
        causeOfBreakdown: 'Clutch failure',
        remarks: 'Under repair',
      },
      {
        id: 8,
        vehicleNumber: 'AS21602',
        routeNumber: '14B',
        driverId: 'D008',
        conductorId: 'C008',
        tripCompleted: '5',
        kmDriven: '110',
        placeOfBreakdown: 'Hatigaon',
        dateOfBreakdown: new Date('2026-01-22'),
        timeOfBreakdown: '15:00',
        causeOfBreakdown: 'Radiator leak',
        remarks: 'Cooling system fixed',
      },
      {
        id: 9,
        vehicleNumber: 'AS21603',
        routeNumber: '9A',
        driverId: 'D009',
        conductorId: 'C009',
        tripCompleted: '9',
        kmDriven: '200',
        placeOfBreakdown: 'Basistha',
        dateOfBreakdown: new Date('2026-01-21'),
        timeOfBreakdown: '08:45',
        causeOfBreakdown: 'Suspension damage',
        remarks: 'Road condition caused issue',
      },
      {
        id: 10,
        vehicleNumber: 'AS21604',
        routeNumber: '11D',
        driverId: 'D010',
        conductorId: 'C010',
        tripCompleted: '4',
        kmDriven: '90',
        placeOfBreakdown: 'Chandmari',
        dateOfBreakdown: new Date('2026-01-20'),
        timeOfBreakdown: '17:30',
        causeOfBreakdown: 'Steering issue',
        remarks: 'Safety inspection pending',
      },
      {
        id: 11,
        vehicleNumber: 'AS21605',
        routeNumber: '16C',
        driverId: 'D011',
        conductorId: 'C011',
        tripCompleted: '6',
        kmDriven: '135',
        placeOfBreakdown: 'Garchuk',
        dateOfBreakdown: new Date('2026-01-19'),
        timeOfBreakdown: '10:00',
        causeOfBreakdown: 'Air conditioning failure',
        remarks: 'Compressor replacement',
      },
      {
        id: 12,
        vehicleNumber: 'AS21606',
        routeNumber: '7B',
        driverId: 'D012',
        conductorId: 'C012',
        tripCompleted: '3',
        kmDriven: '75',
        placeOfBreakdown: 'Panjabari',
        dateOfBreakdown: new Date('2026-01-18'),
        timeOfBreakdown: '12:00',
        causeOfBreakdown: 'Wiper malfunction',
        remarks: 'Minor repair done',
      },
    ];
